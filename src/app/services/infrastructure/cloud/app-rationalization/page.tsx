...
export const metadata: Metadata = { title: "App Rationalization", description: "Application portfolio rationalization by ConglomerateIT — retire, replace, rehost, replatform, and refactor for cloud efficiency." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Application portfolio rationalization by ConglomerateIT — retire, replace, rehost, replatform, and refactor for cloud efficiency."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "App Rationalization" }]}
      intro="ConglomerateIT delivers enterprise-grade App Rationalization services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
