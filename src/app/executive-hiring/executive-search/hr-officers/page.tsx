...
export const metadata: Metadata = { 
  title: "HR Officers Search",
  description: "ConglomerateIT HR Officers Search — placing CHRO & People Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="HR"
      titleHighlight=""
      description="ConglomerateIT places CHRO & People Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "HR Officers Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in CHRO & People Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
