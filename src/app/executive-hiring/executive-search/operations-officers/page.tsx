...
export const metadata: Metadata = { 
  title: "Operations Officers Search",
  description: "ConglomerateIT Operations Officers Search — placing COO & Operations Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Operations"
      titleHighlight=""
      description="ConglomerateIT places COO & Operations Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Operations Officers Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in COO & Operations Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
