...
export const metadata: Metadata = { 
  title: "C-Suite Succession",
  description: "ConglomerateIT C-Suite Succession — placing Executive Leadership Pipeline with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="C-Suite"
      titleHighlight=""
      description="ConglomerateIT places Executive Leadership Pipeline candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "C-Suite Succession" }]}
      intro="ConglomerateIT&apos;s Succession Planning practice specializes in Executive Leadership Pipeline placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
