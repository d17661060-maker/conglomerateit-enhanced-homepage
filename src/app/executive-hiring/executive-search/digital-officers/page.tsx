...
export const metadata: Metadata = { 
  title: "Digital Officers Search",
  description: "ConglomerateIT Digital Officers Search — placing Chief Digital & Technology Officer with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Digital"
      titleHighlight=""
      description="ConglomerateIT places Chief Digital & Technology Officer candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Digital Officers Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in Chief Digital & Technology Officer placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
