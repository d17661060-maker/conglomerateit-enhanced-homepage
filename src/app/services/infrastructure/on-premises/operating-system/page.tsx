...
export const metadata: Metadata = { title: "Operating System Management", description: "Enterprise OS management for Windows Server, Linux, and Unix environments — patching, hardening, and lifecycle management." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Enterprise OS management for Windows Server, Linux, and Unix environments — patching, hardening, and lifecycle management."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Operating System Management" }]}
      intro="ConglomerateIT delivers enterprise-grade Operating System Management services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
