...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Startups & Scale-ups — placing Startup & Growth-Stage Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Startups"
      titleHighlight=""
      description="ConglomerateIT places Startup & Growth-Stage Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Startups & Scale-ups" }]}
      intro="ConglomerateIT&apos;s Functions practice specializes in Startup & Growth-Stage Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
