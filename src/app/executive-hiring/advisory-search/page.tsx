...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Advisory Search — placing Strategic Advisors & Board Advisors with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Advisory"
      titleHighlight=""
      description="ConglomerateIT places Strategic Advisors & Board Advisors candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Advisory Search" }]}
      intro="ConglomerateIT&apos;s Advisory Search practice specializes in Strategic Advisors & Board Advisors placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
