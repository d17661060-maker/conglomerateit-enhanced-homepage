...
export const metadata: Metadata = { title: "AWS", description: "AWS architecture, migration, and managed services by ConglomerateIT — certified Solutions Architects delivering cloud excellence." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="AWS"
      titleHighlight=""
      description="AWS architecture, migration, and managed services by ConglomerateIT — certified Solutions Architects delivering cloud excellence."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "AWS" }]}
      intro="ConglomerateIT delivers enterprise-grade AWS services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
