...
export const metadata: Metadata = { title: "Govern", description: "Data governance frameworks, data quality, and compliance by ConglomerateIT — trusted data for the entire enterprise." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Govern"
      titleHighlight=""
      description="Data governance frameworks, data quality, and compliance by ConglomerateIT — trusted data for the entire enterprise."
      breadcrumbs={[{ label: "Services" }, { label: "Data & Analytics", href: "/services/data-analytics" }, { label: "Govern" }]}
      intro="ConglomerateIT&apos;s Govern phase of the data value chain ensures your data investments deliver real business outcomes. Our data engineers and consultants bring deep expertise in modern data platforms, governance frameworks, and analytics tools to help you get maximum value from your data assets."
