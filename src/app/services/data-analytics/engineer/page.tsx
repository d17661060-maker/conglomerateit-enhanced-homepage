...
export const metadata: Metadata = { title: "Engineer", description: "Data pipeline and ETL/ELT engineering by ConglomerateIT — Spark, dbt, Airflow, and modern data stack expertise." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Engineer"
      titleHighlight=""
      description="Data pipeline and ETL/ELT engineering by ConglomerateIT — Spark, dbt, Airflow, and modern data stack expertise."
      breadcrumbs={[{ label: "Services" }, { label: "Data & Analytics", href: "/services/data-analytics" }, { label: "Engineer" }]}
      intro="ConglomerateIT&apos;s Engineer phase of the data value chain ensures your data investments deliver real business outcomes. Our data engineers and consultants bring deep expertise in modern data platforms, governance frameworks, and analytics tools to help you get maximum value from your data assets."
