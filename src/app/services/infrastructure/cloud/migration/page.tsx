...
export const metadata: Metadata = { title: "Cloud Migration", description: "Zero-downtime cloud migration by ConglomerateIT — proven methodology for migrating enterprise workloads to AWS, Azure, and GCP." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Zero-downtime cloud migration by ConglomerateIT — proven methodology for migrating enterprise workloads to AWS, Azure, and GCP."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Cloud Migration" }]}
      intro="ConglomerateIT delivers enterprise-grade Cloud Migration services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
