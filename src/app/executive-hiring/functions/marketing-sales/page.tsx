...
export const metadata: Metadata = { 
  title: "Marketing and Sales Leadership",
  description: "ConglomerateIT Marketing and Sales Leadership — placing CMO, CRO & Sales Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Marketing"
      titleHighlight=""
      description="ConglomerateIT places CMO, CRO & Sales Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Marketing and Sales Leadership" }]}
      intro="ConglomerateIT&apos;s Functions practice specializes in CMO, CRO & Sales Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
