...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Supply Chain Leadership — placing Chief Supply Chain Officer with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Supply"
      titleHighlight=""
      description="ConglomerateIT places Chief Supply Chain Officer candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Supply Chain Leadership" }]}
      intro="ConglomerateIT&apos;s Functions practice specializes in Chief Supply Chain Officer placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
