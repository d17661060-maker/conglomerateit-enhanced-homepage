...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Board Succession — placing Board Renewal & Succession with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Board"
      titleHighlight=""
      description="ConglomerateIT places Board Renewal & Succession candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Board Succession" }]}
      intro="ConglomerateIT&apos;s Succession Planning practice specializes in Board Renewal & Succession placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
