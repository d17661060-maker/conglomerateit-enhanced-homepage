...
export const metadata: Metadata = { 
  title: "Board of Directors Search",
  description: "ConglomerateIT Board of Directors Search — placing Board Member with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Board"
      titleHighlight=""
      description="ConglomerateIT places Board Member candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Board of Directors Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in Board Member placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
