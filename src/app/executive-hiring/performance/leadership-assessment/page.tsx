...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Leadership Assessment — placing Executive Benchmarking with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Leadership"
      titleHighlight=""
      description="ConglomerateIT places Executive Benchmarking candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Leadership Assessment" }]}
      intro="ConglomerateIT&apos;s Performance practice specializes in Executive Benchmarking placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
