...
export const metadata: Metadata = { title: "Backup & Recovery", description: "Enterprise backup, disaster recovery, and business continuity solutions by ConglomerateIT — zero data loss, fast RTO." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Enterprise backup, disaster recovery, and business continuity solutions by ConglomerateIT — zero data loss, fast RTO."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Backup & Recovery" }]}
      intro="ConglomerateIT delivers enterprise-grade Backup & Recovery services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
