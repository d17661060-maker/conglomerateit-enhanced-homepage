...
export const metadata: Metadata = { 
  title: "Development & Transitions",
  description: "ConglomerateIT Development & Transitions — placing Leadership Development with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Development"
      titleHighlight=""
      description="ConglomerateIT places Leadership Development candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Development & Transitions" }]}
      intro="ConglomerateIT&apos;s Performance practice specializes in Leadership Development placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
