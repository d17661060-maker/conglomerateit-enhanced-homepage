...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Operations & Supply Chain — placing COO & Supply Chain Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Operations"
      titleHighlight=""
      description="ConglomerateIT places COO & Supply Chain Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Operations & Supply Chain" }]}
      intro="ConglomerateIT&apos;s Functions practice specializes in COO & Supply Chain Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
