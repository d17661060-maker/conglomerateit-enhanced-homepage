...
export const metadata: Metadata = { title: "FTP Services", description: "Enterprise FTP and secure file transfer services by ConglomerateIT — SFTP, FTPS, and managed file transfer solutions." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="FTP Services"
      titleHighlight=""
      description="Enterprise FTP and secure file transfer services by ConglomerateIT — SFTP, FTPS, and managed file transfer solutions."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "FTP Services" }]}
      intro="ConglomerateIT delivers enterprise-grade FTP Services services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
