...
export const metadata: Metadata = { title: "Active Directory", description: "Active Directory design, migration, and management by ConglomerateIT — identity, access, and Group Policy expertise." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Active Directory design, migration, and management by ConglomerateIT — identity, access, and Group Policy expertise."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Active Directory" }]}
      intro="ConglomerateIT delivers enterprise-grade Active Directory services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
