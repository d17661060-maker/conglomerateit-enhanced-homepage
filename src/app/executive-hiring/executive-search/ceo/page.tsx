...
export const metadata: Metadata = { 
  title: "CEO Search",
  description: "ConglomerateIT CEO Search — placing Chief Executive Officer with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="CEO"
      titleHighlight=""
      description="ConglomerateIT places Chief Executive Officer candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "CEO Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in Chief Executive Officer placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
