...
export const metadata: Metadata = { 
  title: "CFO & Financial Executives",
  description: "ConglomerateIT CFO & Financial Executives — placing Finance Leadership with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="CFO"
      titleHighlight=""
      description="ConglomerateIT places Finance Leadership candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "CFO & Financial Executives" }]}
      intro="ConglomerateIT&apos;s Functions practice specializes in Finance Leadership placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
