...
export const metadata: Metadata = { title: "Network Security", description: "Enterprise network security — firewalls, IDS/IPS, zero trust architecture, and 24/7 threat monitoring by ConglomerateIT." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Enterprise network security — firewalls, IDS/IPS, zero trust architecture, and 24/7 threat monitoring by ConglomerateIT."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Network Security" }]}
      intro="ConglomerateIT delivers enterprise-grade Network Security services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
