...
export const metadata: Metadata = { 
  title: "CEO Transitions",
  description: "ConglomerateIT CEO Transitions — placing Leadership Transition Management with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="CEO"
      titleHighlight=""
      description="ConglomerateIT places Leadership Transition Management candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "CEO Transitions" }]}
      intro="ConglomerateIT&apos;s Performance practice specializes in Leadership Transition Management placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
