...
export const metadata: Metadata = { title: "Microsoft Azure", description: "Azure cloud services, migration, and managed operations by ConglomerateIT — Microsoft-certified partners for the enterprise." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="Azure cloud services, migration, and managed operations by ConglomerateIT — Microsoft-certified partners for the enterprise."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Microsoft Azure" }]}
      intro="ConglomerateIT delivers enterprise-grade Microsoft Azure services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
