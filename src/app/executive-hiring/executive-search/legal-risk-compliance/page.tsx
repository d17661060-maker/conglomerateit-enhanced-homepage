...
export const metadata: Metadata = { 
  title: "Legal, Risk & Compliance Search",
  description: "ConglomerateIT Legal, Risk & Compliance Search — placing CLO, CRO & Compliance Officers with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Legal,"
      titleHighlight=""
      description="ConglomerateIT places CLO, CRO & Compliance Officers candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Legal, Risk & Compliance Search" }]}
      intro="ConglomerateIT&apos;s Executive Search practice specializes in CLO, CRO & Compliance Officers placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
