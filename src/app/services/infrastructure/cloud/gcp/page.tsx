...
export const metadata: Metadata = { title: "Google Cloud Platform", description: "GCP architecture and managed services by ConglomerateIT — Google Cloud certified engineers for data-intensive workloads." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      titleHighlight=""
      description="GCP architecture and managed services by ConglomerateIT — Google Cloud certified engineers for data-intensive workloads."
      breadcrumbs={[{ label: "Services" }, { label: "Infrastructure", href: "/services/infrastructure" }, { label: "Google Cloud Platform" }]}
      intro="ConglomerateIT delivers enterprise-grade Google Cloud Platform services backed by certified engineers, proven methodologies, and 24/7 managed operations. Our solutions are designed for reliability, security, and scalability — aligned with your compliance requirements and business goals."
