...
export const metadata: Metadata = { title: "Define", description: "Data strategy and roadmap definition by ConglomerateIT — aligning your data investments with business outcomes." };
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Define"
      titleHighlight=""
      description="Data strategy and roadmap definition by ConglomerateIT — aligning your data investments with business outcomes."
      breadcrumbs={[{ label: "Services" }, { label: "Data & Analytics", href: "/services/data-analytics" }, { label: "Define" }]}
      intro="ConglomerateIT&apos;s Define phase of the data value chain ensures your data investments deliver real business outcomes. Our data engineers and consultants bring deep expertise in modern data platforms, governance frameworks, and analytics tools to help you get maximum value from your data assets."
