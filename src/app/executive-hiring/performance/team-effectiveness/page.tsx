...
export const metadata: Metadata = { 
  ...
  description: "ConglomerateIT Team Effectiveness — placing Executive Team Performance with 97% client satisfaction across North America, EMEA, APAC, and India."
};
export default function Page() {
  return (
    <ServiceLayout
      ...
      title="Team"
      titleHighlight=""
      description="ConglomerateIT places Executive Team Performance candidates that transform organizations — research-led search with global reach and a 97% client satisfaction score."
      breadcrumbs={[{ label: "Executive Hiring", href: "/executive-hiring" }, { label: "Team Effectiveness" }]}
      intro="ConglomerateIT&apos;s Performance practice specializes in Executive Team Performance placements. Our research-led methodology combines deep talent market mapping, rigorous competency assessment, and confidential outreach to deliver candidates who not only have the right skills — but the right cultural fit and leadership style for your organization."
